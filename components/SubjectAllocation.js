...
function SubjectAllocation({ theoryObj, practicalObj }) {
    const [practicalTeacherModal, setPracticalTeacherModal] = useState(null)
    const [theoryTeacherModal, setTheoryTeacherModal] = useState(null)
    const [theoryTeacher, setTheoryTeacher] = useState("")
    const [practicalTeacher, setPracticalTeacher] = useState("")
    let detailsCount = 1;
